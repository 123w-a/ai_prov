...
DISH_IMAGE_PROMPT_TEMPLATE = (
    "家常中式美食实拍照片，{dish}，盛放在精致白瓷餐盘中，"
    "自然光照明，暖色调，俯拍45度视角，专业美食摄影，"
    "食物纹理清晰，色泽诱人，构图干净，背景柔和虚化，高清细节，写实，8k，"
    "像真实餐厅出品一样有食欲"
)
# 反向提示词：规避 AI 生图常见的「畸形、水印、卡通感」等破绽，保证像真实成品照
WANX_NEGATIVE_PROMPT = "低分辨率、模糊、畸形、多余元素、水印、文字、过度修饰、卡通、插画、CG感、塑料质感、夸张特效"
